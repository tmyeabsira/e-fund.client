      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 md:p-10">
        ...
        <div className="md:flex md:space-x-6">
          ...
          <div className="md:w-1/3 shadow-lg p-4 h-fit rounded-lg">
            ...
            <div className="mb-4">
              <button onClick={openPopup} className="bg-yellow-500 text-white w-full py-2 rounded-full hover:bg-yellow-600 my-2">
                Share
              </button>
              <SharePopup isOpen={isPopupOpen} onClose={closePopup} url={`localhost:3000/fundraiser/${fundraiser.id}`}/>
              {isCreator ? (
